...
public class DisplayActiveAccountsView extends AppCompatActivity {
    TextView display;

    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_display_active_accounts_view);
        String idList = getIntent().getStringExtra("List of Accounts");
        display = findViewById(R.id.active_list_text);
