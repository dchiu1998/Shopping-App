...
public class DatabaseDriverAndroid extends SQLiteOpenHelper {
  ...
  public void onCreate(SQLiteDatabase sqLiteDatabase) {
    ...
    sql =
        "CREATE TABLE ACCOUNT " + "(ID INTEGER PRIMARY KEY NOT NULL, " + "USERID INTEGER NOT NULL, "
            + "ACTIVE INTEGER, " + "FOREIGN KEY(USERID) REFERENCES USER(ID))";
    sqLiteDatabase.execSQL(sql);

    sql =
        "CREATE TABLE ACCOUNTSUMMARY " + "(ACCTID INTEGER NOT NULL, " + "ITEMID INTEGER NOT NULL, "
            + "QUANTITY INTEGER NOT NULL, " + "FOREIGN KEY(ACCTID) REFERENCES ACCOUNT(ID), "
